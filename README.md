...
- `config/`: contains example configuration files for AQUA analysis of EC-Earth4 experiments. If you find that the configuration files are not aligned to the main branch of AQUA please open an issue. These are now new files supporting jinja2 substitution and the 'kind' option.
